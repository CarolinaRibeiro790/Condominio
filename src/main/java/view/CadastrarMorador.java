...
public class CadastrarMorador extends javax.swing.JFrame {
    ...
    public CadastrarMorador() throws SQLException {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastrar Morador"));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Residencia"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtCodigoResidencia, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        // 1. Criar objeto Moradot com os dados do formulário
        Morador morador = new Morador();

        morador.setNome(txtNome.getText());
        // Formatar a data de dd/MM/yyyy para yyyy-MM-dd
        String dataDigitada = txtNascimento.getText();
        try {
            SimpleDateFormat formatoEntrada = new SimpleDateFormat("dd/MM/yyyy");
            SimpleDateFormat formatoBanco = new SimpleDateFormat("yyyy-MM-dd");
            Date data = formatoEntrada.parse(dataDigitada); // Converte String → Date
            String dataFormatada = formatoBanco.format(data); // Converte Date → String no formato do banco
            morador.setDataNascimento(dataFormatada);
        } catch (ParseException e) {
            JOptionPane.showMessageDialog(null, "Formato de data inválido! Use dd/MM/yyyy.");
            return;
        }
        morador.setCpf(txtCpf.getText().trim());
        morador.setRg(txtRg.getText().trim());
        
        morador.setCodigoEndereco(Integer.parseInt(txtCodigoResidencia.getText()));

        try {
            //Chamar o Controller para salvar
            boolean sucesso = controller.cadastrarMorador(morador);

            if (sucesso) {
                JOptionPane.showMessageDialog(null, morador != null ? morador.toString() : "Morador não cadastrado.");
                voltarMenu();
            } else {
            ...
            Logger.getLogger(CadastrarMorador.class.getName()).log(Level.SEVERE, null, ex);
        }
